...
Revision ID: a5ff0a52501f
Revises: 
Create Date: 2023-05-30 14:11:29.430066
...
def upgrade() -> None:
    ...
    sa.Column('first_name', sa.String(length=208), nullable=True),
    sa.Column('last_name', sa.String(length=280), nullable=True),
    sa.Column('phone', sa.String(length=28), nullable=True),
    sa.Column('role', sa.Enum('approver', 'complainer', 'admin', name='roletype'), server_default='complainer', nullable=False),
    sa.Column('iban', sa.String(length=208), nullable=True),
    ...
    sa.Column('aumount', sa.Float(), nullable=False),
